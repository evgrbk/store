...
class DiscountUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'all_countries' => 'sometimes|boolean',
            ...
            'all_categories' => 'sometimes|boolean',
            ...
            'value' => 'sometimes|int|min:1|max:' . ($this->value_type == Discount::VALUE_TYPE_PERCENT ? '100' : '1000000'),
